...
public class InquiryController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ResponseDto> createInquiry(@RequestBody @Valid CreateInquiryRequestDto requestBody, @AuthenticationPrincipal UserDetails user) {
...
//    public ResponseEntity<? super GetLoginUserResponseDto> getUserInquiry(@PathVariable("userInquiryId") Long userInquiryId) {
